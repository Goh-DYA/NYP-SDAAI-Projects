This project aims to create a custom object detection model by leveraging on transfer learning from the pre-trained CenterNet Resnet50 V1 FPN 512x512 model. 
